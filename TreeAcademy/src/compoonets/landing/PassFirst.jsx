import passFirstProgram from '../../assets/images/pass-first-program.jpg';

export default function PassFirst() {
  return (
    <section id="pass-first" className="py-24 md:py-32 bg-[#F9F7F2]">
      <div className="max-w-6xl mx-auto px-6 md:px-10">
        <div className="grid gap-10 lg:grid-cols-[1.1fr_0.9fr] lg:items-end">
          <div className="max-w-2xl lg:pr-12">
            ...
            <p className="mt-6 text-[#1B432E]/80 text-lg leading-relaxed text-justify">
            ...
            <p className="mt-4 text-[#1B432E]/70 text-lg leading-relaxed text-justify">
